...
''' For ZINC dataset '''
class NitroHy1PositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class NitroHy3PositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class NitroHy2PositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class NitroPositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class NitroNegativeCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class SulfurNegativeCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class OxyHy1PositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class NitroHy1NegativeCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class OxyPositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class SulfurPositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class PhosphorusHy1CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class PhosphorusHy2CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class CarbonHy2NegativeCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class PhosphorusPositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class SulfurHy1PositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class CarbonHy1NegativeCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class PhosphorusHy1PositiveCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class CarbonHy1CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class OxyNegativeCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
...
class AtomMetricsCE(MetricCollection):
    def __init__(self, dataset_infos):
        ...
        class_dict = {'H': HydrogenCE, 'C': CarbonCE, 'N': NitroCE, 'O': OxyCE, 'F': FluorCE, 'B': BoronCE,
                      ...
                      'Si': SiCE, 'C H1': CarbonHy1CE, 'N H1 +': NitroHy1PositiveCE, 'N H3 +': NitroHy3PositiveCE, 
                      'N H2 +': NitroHy2PositiveCE, 'N +':NitroPositiveCE, 'N -': NitroNegativeCE, 'S -': SulfurNegativeCE, 
                      'O H1 +': OxyHy1PositiveCE, 'N H1 -': NitroHy1NegativeCE, 'O +': OxyPositiveCE, 'S +': SulfurPositiveCE, 
                      'P H1': PhosphorusHy1CE, 'P H2': PhosphorusHy2CE, 'C H2 -': CarbonHy2NegativeCE, 'P +': PhosphorusPositiveCE, 
                      'S H1 +': SulfurHy1PositiveCE, 'C H1 -': CarbonHy1NegativeCE, 'P H1 +': PhosphorusHy1PositiveCE, 'O -': OxyNegativeCE,}
